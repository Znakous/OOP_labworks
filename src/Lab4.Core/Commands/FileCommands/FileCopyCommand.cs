...
public class FileCopyCommand : FileSystemCommandBase
{
    ...
    public override CommandExecutionResult ExecuteOnConnected(IFileSystemContext fileSystemContext)
    {
        ...
        IPath sourcePath = pathParser.ParsePath(
            _sourcePath,
            new RelativePriorityStrategy(fileSystemContext.CurrentPath, fileSystem));
        ...
        IPath destinationPath = pathParser.ParsePath(
            _destinationPath,
            new RelativeOnlyStrategy(relationForDestination));
